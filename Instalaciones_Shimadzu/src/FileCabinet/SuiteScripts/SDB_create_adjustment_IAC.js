    ...
    function (serverWidget, record, runtime, search, task, file, config, format, log) {
            ...
            try {
                ...
                if (objData.items && objData.items.length) {
                    ...
                    for (var x = 0; x < count; x++) {
                        ...
                        rcd.setValue({
                            fieldId: 'custrecord_sdb_date_2',
                            value: new Date(),
                            ignoreFieldChange: true
                        })
                        rcd.setValue({
                            fieldId: 'custrecord_sdb_item_fulfillment_2',
                            value: objData.fulfill,
                            ignoreFieldChange: true
                        })
                        rcd.setValue({
                            fieldId: 'custrecord_sdb_item_2',
                            value: thisObj.item,
                            ignoreFieldChange: true
                        })
                        ...
                        if (isSerial) {
                            rcd.setValue({
                                fieldId: 'custrecord_sdb_serial_num_2',
                                value: thisObj.lotNumbners,
                                ignoreFieldChange: true
                            })
                        }
                        rcd.setValue({
                            fieldId: 'custrecord_sdb_subsidiary_2',
                            value: objData.subsidiary,
                            ignoreFieldChange: true
                        })
                        rcd.setValue({
                            fieldId: 'custrecord_sdb_qty_installed_2',
                            value: isSerial ? 1 : thisObj.qty,
                            ignoreFieldChange: true
                        })

                        rcd.setValue({
                            fieldId: 'custrecord_sdb_location_2',
                            value: objData.locationIAC,
                            ignoreFieldChange: true
                        })

                        rcd.setValue({
                            fieldId: 'custrecord_sdb_account_2',
                        ...
                        rcdNew.setValue({
                            fieldId: 'custrecord_sdb_created_2',
                            value: true,
                            ignoreFieldChange: true
                        })
        ...
        function CreateNegativeAdjustment(rec) {
            try {
                var thisRecord = rec;
                var scriptObj = runtime.getCurrentScript();
                var locationIAC = thisRecord.getValue('custrecord_sdb_location_2');
                var item = thisRecord.getValue('custrecord_sdb_item_2');
                var itemFulFill = thisRecord.getValue('custrecord_sdb_item_fulfillment_2');
                var quantity = thisRecord.getValue('custrecord_sdb_qty_installed_2');
                var accountId = scriptObj.getParameter({ name: 'custscript_sdb_account' });
                var subsidiary = thisRecord.getValue('custrecord_sdb_subsidiary_2')
